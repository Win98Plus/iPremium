...
if ($request.url.indexOf(vipa) != -1){
    win98plus.data["psnl_vip_property"] = (vip);
    win98plus.data["fax_balance"] = "99999";
    win98plus.data["used_points"] = "99999";
    win98plus.data["points"] = "99999";
    win98plus.data["pdfword_balance"] = "100010";
    win98plus.data["bookmode_balance"] = 100010;
    win98plus.data["immt_expy_points"] = "99999";
    win98plus.data["ocr_balance"] = 99999;
    win98plus.data["no_login_ocr_balance"] = "99999";
    win98plus.data["CamScanner_RoadMap"] = 100000;
}

if ($request.url.indexOf(vipb) != -1){
    win98plus.data.ar_property["psnl_vip_property"] = (vip);
}
